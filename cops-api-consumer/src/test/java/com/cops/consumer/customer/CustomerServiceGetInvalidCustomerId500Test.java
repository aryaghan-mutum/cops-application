...
public class CustomerServiceGetInvalidCustomerId500Test {
    ...
    public CustomerServiceGetInvalidCustomerId500Test() {
        customerModel = new CustomerModel();
        customerModel.setCustomerId("c002");
    ...
    @Pact(consumer = "customer_consumer_get_api_500_internal_server_error")
    public RequestResponsePact pactForGetCustomer(PactDslWithProvider builder) {
        ...
        RequestResponsePact requestResponsePact = builder
                .given("Customer GET: Invalid customerId")
                .uponReceiving("500 Internal Server Error")
                .path(PATH)
